  ...
  return (
    <div className="page-stack">
      <section className="page-header">
        <div>
          <h1>Configuration</h1>
          <p className="helper-text">Manage staff accounts, roles, and access.</p>
        </div>
      </section>
      <div className="configuration-menu-layout">
        <ConfigurationMenu activeSection="team" />
        <div className="configuration-detail configuration-subpage">
          {canEditTeam ? (
            ...
            <section className="panel table-panel">
              ...
              <div className="review-draft-list">
                <div className="review-draft-list-head" aria-hidden="true">
                  <span>Name</span><span>Role</span><span>Status</span><span>Leads</span><span>Work Items</span>
                </div>
                {staff.map((member) => (
